    ...
    <footer className="relative mt-16 border-t border-white/10">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
        ...
        <div className="flex flex-col items-center md:items-start">
          <h2 className={`${rubik_glitch.className} text-2xl font-bold text-white tracking-wide`}>
            Rise of the Rejects
          </h2>
        ...
        <div className="flex flex-wrap justify-center md:justify-end gap-6 text-sm font-medium text-neutral-200">
          ...
          <Link href="/factions" className="hover:text-white transition">
            Factions
          </Link>
        ...
        <div className="flex justify-center md:justify-end">
          <Link href="/factions">
            <button className="px-4 py-2 bg-white text-black rounded-lg font-semibold shadow hover:bg-neutral-200 transition">
              Join the Cause
            </button>
          </Link>
        </div>
